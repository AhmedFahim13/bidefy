...
export type FilterState = { q: string; status: string; ministry: string };
...
export function Filters({ options, state }: { options: FilterOptions | null; state: FilterState }) {
  ...
  return (
    <form method="get" action="/" className="grid gap-3 rounded-sm border border-rule bg-surface p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)] sm:grid-cols-[1.4fr_0.7fr_1.2fr_auto] sm:items-end">
